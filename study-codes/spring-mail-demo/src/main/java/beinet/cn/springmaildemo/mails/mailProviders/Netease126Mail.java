 ...
 */
@Component
public class Netease126Mail extends MailProvider {
    @Value("${beinet.126.host:imap.126.com}")
    private String host;
    @Value("${beinet.126.protocal:imap}")
    private String protocol;

    @Override
    public boolean match(String mailAddress) {
        return (StringUtils.hasLength(mailAddress)) && mailAddress.toLowerCase().endsWith("@126.com");
    }
